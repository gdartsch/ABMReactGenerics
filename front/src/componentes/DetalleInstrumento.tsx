        ...
        <Container>
                <Row> 
                    ...
                    <Col>
                        ...
                        <Row>
                            <Col>Marca: <h3>{instrumento?.marca}</h3></Col>
                        </Row>
                        <Row>
                            <Col>Modelo: <h3>{instrumento?.modelo}</h3></Col>
                        </Row>
                        <Row>
                            <Col>Costo Envío: <h3>{instrumento?.costoEnvio}</h3></Col>
                        </Row>
                        <Row>
                            <Col>Descripción: <h3>{instrumento?.descripcion}</h3></Col>     
                        </Row>
                    </Col>
                </Row>

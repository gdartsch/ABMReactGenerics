...
export const FrmInstrumento = () => {
    ...
    const getInstrumento = async () => {
        if(Number(idinstrumento) !== 0){
            let instrumentoSelect:Instrumento = await getInstrumentosPorIdFetch(Number(idinstrumento));
    ...
    return (
        ...
        <Form className="form-control">
            ...
            <Form.Group className="mb-3" controlId="formBasicImagen">
                ...
                <Form.Control type="Text" placeholder="Ingrese la imagen" defaultValue={instrumento?.imagen} onChange={e => instrumento.imagen = String(e.target.value)}/>
            </Form.Group>
